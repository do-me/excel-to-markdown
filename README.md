...
Paste a table in Excel, Markdown, HTML, CSV, JSON or text (claude-code) format. Automatically detects the input format and lets you copy to any format like Markdown, Excel, CSV, JSON or HTML! 
